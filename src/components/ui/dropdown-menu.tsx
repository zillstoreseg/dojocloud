...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronLeft className="size-4 ltr:ml-auto ltr:rotate-180 rtl:mr-auto" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-sm py-1.5 text-sm outline-none focus:bg-accent ltr:pl-8 ltr:pr-2 rtl:pr-8 rtl:pl-2',
      className,
    )}
    checked={checked}
    {...props}
