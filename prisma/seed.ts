...
const FLAGS: Array<{
  ...
  { key: 'ai.food_scan', name: 'تحليل صور الوجبات', description: 'المتدرب يصوّر وجبته فتُقرأ سعراتها وماكروزها', type: 'BOOLEAN', defaultEnabled: false, category: 'ai' },
  { key: 'ai.food_scan.daily', name: 'حد تحليل الوجبات اليومي', description: 'أقصى عدد صور يحللها المتدرب الواحد في اليوم', type: 'LIMIT', defaultEnabled: true, defaultLimit: 5, category: 'ai' },
...
const PLANS: Array<{
...
}> = [
  {
    ...
    flags: { 'ai.workout_generation': true, 'ai.nutrition_generation': true, 'leads.crm': true, 'ai.food_scan': true, 'ai.food_scan.daily': 3 },
  },
  {
    key: 'starter',
    nameAr: 'المبتدئ',
